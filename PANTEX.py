...
def main():
    ...
    print ('   [08] Other\n')
    print ('   [10] Exit the PANTEX\n')
    PANTEX = input('PANTEX > ')
    if PANTEX == '1' or PANTEX == '01':
        print ('\n    [01] Nmap')
        print ('    [02] Red Hawk')
        print ('    [03] D-Tect')
        print ('    [04] sqlmap')
